...
impl Lcd {
    ...
    pub fn get_coordinates(&self, field: self::Field) -> u8 {
        self.coordinates.get(field)
    }

    pub fn set_coordinates(&mut self, field: self::Field, data: u8) {
    ...
    pub fn get_control(&self) -> u8 {
        self.control.into_bytes()[0]
    }

    pub fn set_status(&self, data: u8) {
        self.status.into_bytes()[0] = data;
    }

    pub fn set_control(&self, data: u8) {
        self.control.into_bytes()[0] = data;
    }

    pub fn get_lcd(&self, field: Field) -> u8 {
        self.coordinates.get(field)
    }

    pub fn set(&self, dst: &mut Self) {
        dst.status = self.status;
        dst.coordinates = self.coordinates;
    }
