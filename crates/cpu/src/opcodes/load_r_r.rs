...
impl LoadR1R2 {
    pub async fn exec(self, registers: Registers) {
        let (dst, src) = match self {
            ...
            LoadR1R2::BA => (Bits8::B, Bits8::A),
            LoadR1R2::CA => (Bits8::C, Bits8::A),
